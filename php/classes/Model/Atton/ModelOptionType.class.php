...
class ModelOptionType {
	...
	public static function getOptionType($id_option_type) {
		if (isset(self::$types[$id_option_type])) return self::$types[$id_option_type];
		
		self::load_option_types();
		
		if (!isset(self::$types[$id_option_type])) throw new NullPointerException('Optiontype not found.');
